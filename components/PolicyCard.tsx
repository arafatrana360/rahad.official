...
const PolicyCard: React.FC<PolicyCardProps> = ({ policy, lang }) => {
  return (
    <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl transition-all group">
      ...
      <h3 className="text-2xl font-bold mb-4 text-slate-800">{policy.title[lang]}</h3>
      ...
      <button className="mt-8 text-blue-600 font-bold text-sm flex items-center group-hover:translate-x-2 transition-transform">
